  ...
  return (
    <div className="App">
      <div className="heading">
        <h1 className="title">Magic Of Soil</h1>

        <h2 className="quote-1">
          “The Only Magic Material that Turns Death into Life.” – Sadhguru
        </h2>
        <p className="intro">
          The Save Soil movement is about bringing humanity together to keep the
          magic of soil alive.
        </p>
      </div>
      <Fad />
      <div className="video">
        ...
        <iframe
          ...
          width="560"
          height="315"
          src="https://www.youtube.com/embed/n72GJ0lziw8"
      ...
      <div className="social-container">
        <div>
          ...
          <a target="_blank" href="https://www.instagram.com/consciousplanet/">
            <svg
              className="social-image"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
            >
              <title>icon</title>
              <path
                d="M24 17.06a6.88 6.88 0 1 0 6.77 6.88A6.83 6.83 0 0 0 24 17.06zm0 12.75a5.88 5.88 0 1 1 5.77-5.88A5.83 5.83 0 0 1 24 29.82zM24 .52A23.48 23.48 0 1 0 47.5 24 23.52 23.52 0 0 0 24 .52zm0 46A22.48 22.48 0 1 1 46.5 24 22.52 22.52 0 0 1 24 46.48zM31.76 14a2.21 2.21 0 1 0 2.19 2.21A2.2 2.2 0 0 0 31.76 14zm0 3.43a1.21 1.21 0 1 1 1.19-1.21 1.2 1.2 0 0 1-1.19 1.17zM30 9.94H18a7.91 7.91 0 0 0-7.84 8V30A7.91 7.91 0 0 0 18 38h12a7.91 7.91 0 0 0 7.84-8V17.9A7.91 7.91 0 0 0 30 9.94zm6.84 20a6.91 6.91 0 0 1-6.84 7H18a6.91 6.91 0 0 1-6.84-7V17.9a6.91 6.91 0 0 1 6.84-7h12a6.91 6.91 0 0 1 6.84 7V30z"
              ></path>
            </svg>
          </a>
          <a target="_blank" href="https://twitter.com/cpsavesoil">
            <svg
              className="social-image"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 48 48"
          ...
          <a
            target="_blank"
            href="https://www.youtube.com/channel/UC9WwGTaKB0h1pkUZAVwVC1A"
          >
            <svg
              className="social-image"
              xmlns="http://www.w3.org/2000/svg"
            ...
            >
              <title>icon</title>
              <path
                d="M18.38 31.11L30.73 24l-12.35-7.11v14.22zm1-12.49L28.72 24l-9.34 5.38V18.62zm17.17-9.5H11.44A7.94 7.94 0 0 0 3.5 17v14a7.94 7.94 0 0 0 7.94 7.92h25.12A7.94 7.94 0 0 0 44.5 31V17a7.94 7.94 0 0 0-7.94-7.88zM43.5 31a6.94 6.94 0 0 1-6.94 6.92H11.44A6.94 6.94 0 0 1 4.5 31V17a6.94 6.94 0 0 1 6.94-6.92h25.12A6.94 6.94 0 0 1 43.5 17v14z"
              ></path>
            </svg>
          </a>
        </div>
      ...
      <div>
        <div className="quote-2">
          “Creating a Conscious Planet is possible only by raising human
          consciousness. It is important for all – particularly leaders whose
          decisions affect millions of lives – to be conscious and inclusive.” –
          Sadhguru
        </div>
      </div>
      <footer>
        This webpage is made with 💛 to promote Conscious Planet movement and is a
        part of my "learn to code" project. All the content is from savesoil.org
        or other Sadhguru official channels.
      </footer>
    </div>
  );
}
